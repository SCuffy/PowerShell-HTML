$SiteAddress = "https://techcommunity.microsoft.com/t5/azure-data-explorer/the-new-scan-operator-process-mining-in-azure-data-explorer/ba-p/2378795"
$HttpContent = Invoke-WebRequest -URI $SiteAddress -Body System.Object 
